$(document).ready(function() {
	...
	var mybot = '<div class="chatCont" id="chatCont">'+
								'<div class="bot_profile">'+
									'<img src="https://i.pinimg.com/originals/8f/45/e1/8f45e12d0bbe76715b4c7b07a652104c.jpg" class="bot_p_img">'+
									'<div class="close">'+
							...
							'<div class="profile_div">'+
								'<div class="row">'+
									'<div class="col-hgt">'+
										'<img src="https://i.pinimg.com/originals/8f/45/e1/8f45e12d0bbe76715b4c7b07a652104c.jpg" class="img-circle img-profile">'+
									'</div><!--col-hgt end-->'+
									'<div class="col-hgt">'+
										'<div class="chat-txt">'+
											'Talk With Morgan!'+
	...
	var session = function() {
		...
		if(sessionStorage.getItem('session')) {
			...
			// get Timestamp
			var timestamp = Date.now(1/27/2019);
			// get Day
			var date = new Date(1/27/2019);
	...
	function addSuggestion(textToAdd) {
		setTimeout(function() {
			...
			for(i=0;i<suggLength;i++) {
				$('<span class="sugg-options">'+suggestions[i]+'</span>').appendTo('Gode');
			}
			scrollToBottomOfResults();
		}, 1000);
	}
